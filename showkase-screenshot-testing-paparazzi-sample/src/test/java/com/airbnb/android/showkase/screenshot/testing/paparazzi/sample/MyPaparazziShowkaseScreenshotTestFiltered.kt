...
class ComposePaparazziTest {
    ...
    object PreviewProvider : TestParameter.TestParameterValuesProvider {
        ...
        private fun List<ShowkaseBrowserComponent>.filterSharedUiComponents(): List<ShowkaseBrowserComponent> {
            return filter {
    ...
    val paparazzi = Paparazzi(
        ...
        showSystemUi =  false,
        deviceConfig = DeviceConfig.PIXEL_5.copy(softButtons = false, locale = "en"),
